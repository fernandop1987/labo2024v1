...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DTbb0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CAbb0001", "DTbb0001" )
  
  DR_drifting_guantesblancos( "DRbb0001", "CAbb0001" )
  FE_historia_guantesblancos( "FEbb0001", "DRbb0001" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TSbb0002", "FEbb0001" )
  
  HT_tuning_guantesblancos( "HTbb0002", "TSbb0002" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZbb0002", c("HTbb0002", "TSbb0002") )
