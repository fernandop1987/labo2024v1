...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DTf0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CAf0001", "DTf0001" )
  
  DR_drifting_guantesblancos( "DRf0001", "CAf0001" )
  FE_historia_guantesblancos( "FEf0001", "DRf0001" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TSf0002", "FEf0001" )
  
  HT_tuning_guantesblancos( "HTf0002", "TSf0002" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZf0002", c("HTf0002", "TSf0002") )
