...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DTe0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CAe0001", "DTe0001" )
  
  DR_drifting_guantesblancos( "DRe0001", "CAe0001" )
  FE_historia_guantesblancos( "FEe0001", "DRe0001" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TSe0002", "FEe0001" )
  
  HT_tuning_guantesblancos( "HTe0002", "TSe0002" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZe0002", c("HTe0002", "TSe0002") )
