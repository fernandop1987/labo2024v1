...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$training <- c(202101, 202012, 202011, 202010, 202009, 202008, 202007, 202005, 202004)
  param_local$train$validation <- c(202102)
  param_local$train$testing <- c(202103, 202105)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DTc0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CAc0001", "DTc0001" )
  
  DR_drifting_guantesblancos( "DRc0001", "CAc0001" )
  FE_historia_guantesblancos( "FEc0001", "DRc0001" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TSc0002", "FEc0001" )
  
  HT_tuning_guantesblancos( "HTc0002", "TSc0002" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZc0002", c("HTc0002", "TSc0002") )
