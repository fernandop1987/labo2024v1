...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DTaa0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CAaa0001", "DTaa0001" )
  
  DR_drifting_guantesblancos( "DRaa0001", "CAaa0001" )
  FE_historia_guantesblancos( "FEaa0001", "DRaa0001" )
  
  ###TS_strategy_guantesblancos_202109( "TSaa0001", "FEaa0001" )
  
  ###HT_tuning_guantesblancos( "HTaa0001", "TSaa0001" )
  
  # El ZZ depente de HT y TS
  ###ZZ_final_guantesblancos( "ZZaa0001", c("HTaa0001","TSaa0001") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TSaa0002", "FEaa0001" )
  
  HT_tuning_guantesblancos( "HTaa0002", "TSaa0002" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZaa0002", c("HTaa0002", "TSaa0002") )
